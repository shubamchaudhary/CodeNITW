  ...
  return (
    <div className='mb-4 bg-white dark:bg-[#3A3A3CFF] border-gray-200 p-10 rounded-lg shadow overflow-auto'>
      ...
      <div className="flex flex-col ">
        {cards.map((card) => (
          <MLCard name={card.name} description={card.description} videoLink={card.videoLink} problemSetLink={card.problemsetLink} />
        ))}
      </div>
    </div>
  );
...
export function DevContainer({name, description, cards}){
  return (
    <div className='mb-4 bg-white dark:bg-[#3A3A3CFF] border-gray-200 p-10 rounded-lg shadow overflow-auto'>
      ...
      <div className="flex flex-col ">
        {cards.map((card) => (
          <DevCard name={card.name} description={card.description} videoLink={card.videoLink} problemSetLink={card.problemsetLink} />
        ))}
      </div>
    </div>
  );
 ...
 export function CoreCSEContainer({name, description, cards}){
  return (
    <div className='mb-4 bg-white dark:bg-[#3A3A3CFF] border-gray-200 p-10 rounded-lg shadow overflow-auto'>
      ...
      <div className="flex flex-col ">
        {cards.map((card) => (
          <CoreCSECard name={card.name} description={card.description} videoLink={card.videoLink} problemSetLink={card.problemsetLink} />
        ))}
      </div>
    </div>
  );
